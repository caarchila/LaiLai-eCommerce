  ...
  return(
    <Modal
      ...
      >
        ...
        <Modal.Body>¡Tu orden se agregó<br/>exitosamente al carrito!</Modal.Body>
        <Modal.Footer>
           <Button block variant="danger" id="btnIrAlCarrito" className="my-1" onClick={abrirCarrito}>Ir al carrito</Button>
           <Button block variant="light" id="btnSeguirOrdenando" className="my-1" onClick={ocultarModal}>Seguir ordenando</Button>
         </Modal.Footer>
      </Modal>
  );
}
