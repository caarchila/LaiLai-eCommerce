...
class MapaGL extends Component{
  ...
  componentDidMount() {
    mapboxgl.accessToken = 'pk.eyJ1IjoidG9iZXJhbDk4IiwiYSI6ImNrajh2N3hpcTBjc3IydXA3MWZwMWNtZnYifQ.nrwnBSuM3s8or0EJkhBZEw';
    navigator.geolocation.getCurrentPosition((position) =>{
        ...
        this.setState({
          marker:new mapboxgl.Marker({
              ...
              const geocoder = new MapboxGeocoder({
                ...
                document.getElementById(`coordenadas${this.props.id}`).appendChild(geocoder.onAdd(this.state.map))
      ...
      <>
        {
          ...
          (this.props.boton)
          ?
          <button onClick={this.setLocation} className="btn btn-danger location miUbicacion d-block"> usar ubicacion actual</button>
          :
          <button onClick={this.setLocation} className="btn btn-danger location miUbicacion d-none"> usar ubicacion actual</button>
        }
        {
          (this.props.buscador)
          ?
