    ...
    <Col sm={12} md={9} xl={9}>
        <Form.Check
          ...
          <Collapse  in={selectedOption === "CRD"}>
            <div id="example-collapse-text"  className="descripcion-radio-dinamico">El cobro se realizará en el momento de la entrega por medio de un POS inalámbrico, por lo que debes tener a la mano tu tarjeta de crédito.</div>
          </Collapse>
          <Form.Check
              custom
              type="radio"
...
export default connect(null,mapDispatchToProps)(DetalleHistorial);
