        ...
        <Form>
          <Form.Row>
            <Form.Group as={Col} controlId="formGridEmail">
              ...
              <Form.Control onChange={this.setField} name="nombre" type="text" placeholder=" Nombres" />
            </Form.Group>

            <Form.Group as={Col} controlId="formGridPassword">
              <Form.Label>Apellidos:</Form.Label>
              <Form.Control onChange={this.setField} name="apellido" type="text" placeholder="Apellidos" />
            </Form.Group>
          </Form.Row>
          <Form.Row>
            <Form.Group as={Col} controlId="formGridEmail">
              <Form.Label>Email:</Form.Label>
              <Form.Control onChange={this.setField} name="email" type="email" placeholder=" Email" />
            </Form.Group>

            <Form.Group as={Col} controlId="formGridPassword">
              <Form.Label>Password:</Form.Label>
              <Form.Control onChange={this.setField} name="password" type={this.state.type ? "text" : "password"}  placeholder="Password" />
            </Form.Group>
            <i onClick={this.handleClick} className="icons">{eye}</i>
          </Form.Row>
          <Form.Row>
            <Form.Group as={Col} controlId="formGridState">
              <Form.Label>Genero</Form.Label>
              <Form.Control onChange={this.setField} name="genero" as="select" defaultValue="Choose...">
          ...
          <center>
            <Button variant="danger" type="submit" className="registrar" onClick={this.save}>
              Registrarme
            </Button>
