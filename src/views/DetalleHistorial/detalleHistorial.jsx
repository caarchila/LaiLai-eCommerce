    ...
    return(
        ...
        <Row>
          <Col className="text-justify my-2">
            <h4><strong>Finalización de Orden</strong></h4>
            <p>Por favor verifique su orden y si todo está correcto confirme para preparar su pedido.</p>
          </Col>
        </Row>
          <Row>
            <Col sm={12} md={8} xl={8} >
              <Row>
                  <Col >
                    {(historial.length === 0)?<Spinner animation="grow" variant="warning" />:<SeccionDatosPersonales historial={historial} boton={idBoton}/>}
                  </Col>
              </Row>
              <Row>
                <Col>
                  <h4 className="my-3"><strong>Revisión de productos</strong></h4>
              </Col>
              </Row>
              <Row>
                <Col  >
                  {(historial.length === 0)?<Spinner animation="grow" variant="warning" />:<Producto   historial={historial}/>}

                </Col>
              </Row>
            </Col>
            <Col sm={12} md={4} xl={4}>
              {(historial.length === 0)?<Spinner animation="grow" variant="warning" />: <Resumen  historial={historial} boton={idBoton} />}
            </Col>
          </Row>
        </Container>
    )
